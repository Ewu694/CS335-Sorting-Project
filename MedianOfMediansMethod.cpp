...
int MedianOfMediansMethod::medianOfFive(int a, int b, int c, int d, int e) 
{
    if (a > b) std::swap(a, b);
    if (c > d) std::swap(c, d);
    if (a > c) std::swap(a, c);
...
int MedianOfMediansMethod::medianOfMedians(std::vector<int>& nums, std::vector<int>::iterator low, std::vector<int>::iterator high) 
{
...
int MedianOfMediansMethod::medianOfMediansMethod(std::vector<int>& nums, int& duration) 
{
